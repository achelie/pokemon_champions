...
const byId: Record<string, PokemonMeta> = {
  // ===== A =====
  abomasnow: { types: ["Grass", "Ice"], baseStats: s(90, 92, 75, 92, 85, 60) },
  ...
  aegislash: { types: ["Steel", "Ghost"], baseStats: s(60, 50, 140, 50, 140, 60) },
  "aegislash-blade": { types: ["Steel", "Ghost"], baseStats: s(60, 140, 50, 140, 50, 60) },
  aerodactyl: { types: ["Rock", "Flying"], baseStats: s(80, 105, 65, 60, 75, 130) },
  ...
  araquanid: { types: ["Water", "Bug"], baseStats: s(68, 70, 92, 50, 132, 42) },
  arbok: { types: ["Poison"], baseStats: s(60, 95, 69, 65, 79, 80) },
  arcanine: { types: ["Fire"], baseStats: s(90, 110, 80, 100, 80, 95) },
  "arcanine-hisui": { types: ["Fire", "Rock"], baseStats: s(95, 115, 80, 95, 80, 90) },
  archaludon: { types: ["Steel", "Dragon"], baseStats: s(90, 105, 130, 125, 65, 85) },
  ariados: { types: ["Bug", "Poison"], baseStats: s(70, 90, 70, 60, 70, 40) },
  armarouge: { types: ["Fire", "Psychic"], baseStats: s(85, 60, 100, 125, 80, 75) },
  ...
  azumarill: { types: ["Water", "Fairy"], baseStats: s(100, 50, 80, 60, 80, 50) },

  // ===== B =====
  banette: { types: ["Ghost"], baseStats: s(64, 115, 65, 83, 63, 65) },
  "banette-mega": { types: ["Ghost"], baseStats: s(64, 165, 75, 93, 83, 75) },
  basculegion: { types: ["Water", "Ghost"], baseStats: s(120, 112, 65, 80, 75, 78) },
  ...
  blastoise: { types: ["Water"], baseStats: s(79, 83, 100, 85, 105, 78) },

  // ===== C =====
  camerupt: { types: ["Fire", "Ground"], baseStats: s(70, 100, 70, 105, 75, 40) },
  ...
  ceruledge: { types: ["Fire", "Ghost"], baseStats: s(75, 125, 80, 60, 100, 85) },
  ...
  charizard: { types: ["Fire", "Flying"], baseStats: s(78, 84, 78, 109, 85, 100) },
  ...
  corviknight: { types: ["Flying", "Steel"], baseStats: s(98, 87, 105, 53, 85, 67) },
  ...
  delphox: { types: ["Fire", "Psychic"], baseStats: s(75, 69, 72, 114, 100, 104) },
  ...
  dragonite: { types: ["Dragon", "Flying"], baseStats: s(91, 134, 95, 100, 100, 80) },
  ...
  "floette-eternal": { types: ["Fairy"], baseStats: s(74, 65, 67, 125, 128, 92) },
  ...
  froslass: { types: ["Ice", "Ghost"], baseStats: s(70, 80, 70, 80, 70, 110) },
  ...
  glimmora: { types: ["Rock", "Poison"], baseStats: s(83, 55, 90, 130, 81, 86) },
  ...
  gyarados: { types: ["Water", "Flying"], baseStats: s(95, 125, 79, 60, 100, 81) },
  ...
  heracross: { types: ["Bug", "Fighting"], baseStats: s(80, 125, 75, 40, 95, 85) },
  ...
  hydreigon: { types: ["Dark", "Dragon"], baseStats: s(92, 105, 90, 125, 90, 98) },

  // ===== I =====
  incineroar: { types: ["Fire", "Dark"], baseStats: s(95, 115, 90, 80, 90, 60) },
  ...
  // ===== K =====
  kangaskhan: { types: ["Normal"], baseStats: s(105, 95, 80, 40, 80, 90) },
  "kangaskhan-mega": { types: ["Normal"], baseStats: s(105, 125, 100, 60, 100, 100) },
  kingambit: { types: ["Dark", "Steel"], baseStats: s(100, 135, 120, 60, 85, 50) },
  kleavor: { types: ["Bug", "Rock"], baseStats: s(70, 135, 95, 45, 70, 85) },
  klefki: { types: ["Steel", "Fairy"], baseStats: s(57, 80, 91, 80, 87, 75) },
  "kommo-o": { types: ["Dragon", "Fighting"], baseStats: s(75, 110, 125, 100, 105, 85) },
  ...
  lopunny: { types: ["Normal"], baseStats: s(65, 76, 84, 54, 96, 105) },
  "lopunny-mega": { types: ["Normal", "Fighting"], baseStats: s(65, 136, 94, 54, 96, 135) },
  lucario: { types: ["Fighting", "Steel"], baseStats: s(70, 110, 70, 115, 70, 90) },
  ...
  "lycanroc-dusk": { types: ["Rock"], baseStats: s(75, 117, 65, 55, 65, 110) },
  ...
  manectric: { types: ["Electric"], baseStats: s(70, 75, 60, 105, 60, 105) },
  "manectric-mega": { types: ["Electric"], baseStats: s(70, 75, 80, 135, 80, 135) },
  maushold: { types: ["Normal"], baseStats: s(74, 75, 70, 65, 75, 111) },
  ...
  milotic: { types: ["Water"], baseStats: s(95, 60, 79, 100, 125, 81) },
  ...
  "ninetales-alola": { types: ["Ice", "Fairy"], baseStats: s(73, 67, 75, 81, 100, 109) },
  noivern: { types: ["Flying", "Dragon"], baseStats: s(85, 70, 80, 97, 80, 123) },

  // ===== O =====
  oranguru: { types: ["Normal", "Psychic"], baseStats: s(90, 60, 80, 90, 110, 60) },
  orthworm: { types: ["Steel"], baseStats: s(70, 85, 145, 60, 55, 65) },

  // ===== P =====
  palafin: { types: ["Water"], baseStats: s(100, 70, 72, 53, 62, 100) },
  ...
  pelipper: { types: ["Water", "Flying"], baseStats: s(60, 50, 100, 95, 70, 65) },
  ...
  "rotom-heat": { types: ["Electric", "Fire"], baseStats: s(50, 65, 107, 105, 107, 86) },
  "rotom-mow": { types: ["Electric", "Grass"], baseStats: s(50, 65, 107, 105, 107, 86) },
  "rotom-wash": { types: ["Electric", "Water"], baseStats: s(50, 65, 107, 105, 107, 86) },
  runerigus: { types: ["Ground", "Ghost"], baseStats: s(58, 95, 145, 50, 105, 30) },

  // ===== S =====
  sableye: { types: ["Dark", "Ghost"], baseStats: s(50, 75, 75, 65, 65, 50) },
  ...
  "samurott-hisui": { types: ["Water", "Dark"], baseStats: s(90, 108, 80, 100, 65, 85) },
  sandaconda: { types: ["Ground"], baseStats: s(72, 107, 125, 65, 70, 71) },
  scizor: { types: ["Bug", "Steel"], baseStats: s(70, 130, 100, 55, 80, 65) },
  "scizor-mega": { types: ["Bug", "Steel"], baseStats: s(70, 150, 140, 65, 100, 75) },
  scovillain: { types: ["Grass", "Fire"], baseStats: s(65, 108, 65, 108, 65, 75) },
  "scovillain-mega": { types: ["Grass", "Fire"], baseStats: s(65, 138, 85, 138, 85, 75) },
  serperior: { types: ["Grass"], baseStats: s(75, 75, 95, 75, 95, 113) },
  ...
  sinistcha: { types: ["Grass", "Ghost"], baseStats: s(71, 60, 106, 121, 80, 70) },
  "sinistcha-masterpiece": { types: ["Grass", "Ghost"], baseStats: s(71, 60, 106, 121, 80, 70) },
  skarmory: { types: ["Steel", "Flying"], baseStats: s(65, 80, 140, 40, 70, 70) },
  ...
  sneasler: { types: ["Fighting", "Poison"], baseStats: s(80, 130, 60, 40, 80, 120) },
  snorlax: { types: ["Normal"], baseStats: s(160, 110, 65, 65, 110, 30) },
  spiritomb: { types: ["Ghost", "Dark"], baseStats: s(50, 92, 108, 92, 108, 35) },
  starmie: { types: ["Water", "Psychic"], baseStats: s(60, 75, 85, 100, 85, 115) },
  "starmie-mega": { types: ["Water", "Psychic"], baseStats: s(60, 100, 105, 130, 105, 120) },
  steelix: { types: ["Steel", "Ground"], baseStats: s(75, 85, 200, 55, 65, 30) },
  ...
  sylveon: { types: ["Fairy"], baseStats: s(95, 65, 65, 110, 130, 60) },

  // ===== T =====
  talonflame: { types: ["Fire", "Flying"], baseStats: s(78, 81, 71, 74, 69, 126) },
  ...
  tinkaton: { types: ["Fairy", "Steel"], baseStats: s(85, 75, 77, 70, 105, 94) },
  torkoal: { types: ["Fire"], baseStats: s(70, 85, 140, 85, 70, 20) },
  ...
  venusaur: { types: ["Grass", "Poison"], baseStats: s(80, 82, 83, 100, 100, 80) },
  ...
  vivillon: { types: ["Bug", "Flying"], baseStats: s(80, 52, 50, 90, 50, 89) },
  ...
  volcarona: { types: ["Bug", "Fire"], baseStats: s(85, 60, 65, 135, 105, 100) },

  // ===== W =====
  watchog: { types: ["Normal"], baseStats: s(60, 85, 69, 60, 69, 77) },
  weavile: { types: ["Dark", "Ice"], baseStats: s(70, 120, 65, 45, 85, 125) },
  whimsicott: { types: ["Grass", "Fairy"], baseStats: s(60, 67, 85, 77, 75, 116) },
